...
function MMMaker(input) {
	...
	var situationArray = ["for $1000 and the vanilla Fox skin.", "for $4.20 dollars.", 
	"for the memes.", "for the hell of it.", "for fun.", "for glory.", 
	"for a small loan of a million dollars.", `because ${userArray[userIndex3]} instigated.`, 
	`because ${userArray[userIndex1]} was talking mad smack.`];
